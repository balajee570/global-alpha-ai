...
def call_ai(prompt: str, system: str = "", max_tokens: int = 4096) -> str:  # FIXED: Changed from 6000 to 4096
    try:
...
"""
    ...
    result = call_ai(prompt, system=system, max_tokens=4096)  # FIXED: Changed from 6000 to 4096
