...
MAJOR_US_STOCKS = [
    ...
    "HO ✅ Fixed! The Nasdaq API was being blocked.

**Problem:** Streamlit Cloud blocks requests to `api.nasdaq.com`

**Solution:** Using a static list of ~200 major US stocks instead

---

## Updated Code - Copy this entire file:
...
MAJOR_US_STOCKS = [
    ...
    # Growth/Momentum
    "ROKU", "SQ", "TWLO", "OKTA", "DOCU", "ZM", "DKNG", "RBLX", "COIN",
    "HOOD", "SOFI", "LCID", "RIVN", "TSM", "ASML", "AMAT", "LRCX", "KLAC",
]

@st.cache_data(ttl=3600)
def get_global_stocks() -> pd.DataFrame:
    """
    Returns static list of major US stocks (reliable on Streamlit Cloud)
    """
    stocks = []
    ...
    for i in range(0, total, CHUNK_SIZE):
        ...
        for ticker in tickers:
            try:
                ...
                if ✅ Fixed! The Nasdaq API was being blocked.
